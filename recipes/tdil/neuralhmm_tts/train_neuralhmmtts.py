...
dataset_config = BaseDatasetConfig(
    formatter="tdil", meta_file_train="txt.done.data", path=os.path.join("..", "TDIL-TA/")
)
...
config = NeuralhmmTTSConfig(  # This is the config that is saved for the future use
    ...
    use_phonemes=True,
    phoneme_language="ta-in",
    phoneme_cache_path=os.path.join(output_path, "phoneme_cache"),
    precompute_num_workers=8,
    mel_statistics_parameter_path=os.path.join(output_path, "td_parameters.pt"),
