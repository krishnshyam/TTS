...
from TTS.tts.utils.text.phonemizers.ta_in_phonemizer import TA_IN_Phonemizer

PHONEMIZERS = {b.name(): b for b in (ESpeak, Gruut, JA_JP_Phonemizer, TA_IN_Phonemizer)}
...
DEF_LANG_TO_PHONEMIZER["ta-in"] = TA_IN_Phonemizer.name()
...
def get_phonemizer_by_name(name: str, **kwargs) -> BasePhonemizer:
    ...
    if name == "ta_in_phonemizer":
        return TA_IN_Phonemizer(**kwargs)
